	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#">vasorg-CRM</a>
			</div>
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav">
					<li><a
						href="${pageContext.request.contextPath}/customer/customerlist">CustomerList</a>
					</li>
					<li><a href="#">Services-comingsoon</a></li>
					<li><a href="#">Contact-comingsoon</a></li>
					<li><a href="#" data-toggle="dropdown">Notifications<span
							class="glyphicon glyphicon-bell" style="top: 2px; left: 2px;"></span>
							<span id="notification-count"
							class="badge-notify badge badge-light "></span></a>
						<ul id="notification_dropdown"class="dropdown-menu">
							<li><p class="p-nonotify">You have 3 Notifications</p></li>
...
<!-- 							<li><a href="#">JavaScript</a></li> -->
	...
	<header class="business-header">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="tagline">Welcome to VasOrg CRM</h1>
				</div>
			</div>
		</div>
	</header>
